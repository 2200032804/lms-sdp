...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" sizes="16x16" href="landing/img/Acadamex.png">
    ...
    <div class="container-fluid p-0">
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-2 py-lg-0 px-lg-3">
            <a href="index" class="navbar-brand ml-lg-3">
                <h1 class="m-0 text-primary">LMS</h1>
            </a>
            ...
            <div class="row">
                <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="./landing/img/about.jpg" style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-7">
                    ...
                    <p>LMS is an educational website based in India. We are committed to 
                        ...
                        academic excellence or a professional seeking to enhance your skills, LMS is here to
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5" style="min-height: 500px;">
                    <div class="position-relative h-100">
                        <img class="position-absolute w-100 h-100" src="./landing/img/feature.jpg" style="object-fit: cover;">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="profile-card">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="img2"><img src="./landing/img/a2.jpeg" alt=""></div>
                        <div class="main-text">
                            <h2>Suraj Kumar</h2>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="img2"><img src="./landing/img/a4.png" alt=""></div>
                        <div class="main-text">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <div class="img2"><img src="./landing/img/a6.jpg" alt=""></div>
                        <div class="main-text">
                            <h2>Vachaspathi</h2>
